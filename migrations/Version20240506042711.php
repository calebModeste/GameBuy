 ...
 */
final class Version20240506042711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre CHANGE game_id_id game_offre_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre CHANGE game_offre_id game_id_id INT DEFAULT NULL');
